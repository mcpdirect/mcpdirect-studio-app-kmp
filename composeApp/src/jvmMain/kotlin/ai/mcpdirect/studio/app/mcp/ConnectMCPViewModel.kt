...
class ConnectMCPViewModel(): ViewModel(), MCPServerNotificationHandler {
    private val _makers = mutableStateMapOf<String, MCPServer>()
    ...
    fun fetchServers() {
        viewModelScope.launch {
            withContext(Dispatchers.IO){
                servers =  MCPDirectStudio.getMCPServers().toList()
            }
        }
    }
